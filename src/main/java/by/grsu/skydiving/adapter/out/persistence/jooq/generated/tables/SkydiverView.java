...
public class SkydiverView extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> JUMPING_AMOUNT = createField(DSL.name("jumping_amount"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.skydiver_view.is_internal</code>.
     */
    public final TableField<Record, Boolean> IS_INTERNAL = createField(DSL.name("is_internal"), SQLDataType.BOOLEAN, this, "");
