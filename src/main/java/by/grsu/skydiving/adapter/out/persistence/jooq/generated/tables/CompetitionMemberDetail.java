...
public class CompetitionMemberDetail extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> MEMBER_NUMBER =
        createField(DSL.name("member_number"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.competition_member_detail.is_junior</code>.
     */
    public final TableField<Record, Boolean> IS_JUNIOR = createField(DSL.name("is_junior"),
