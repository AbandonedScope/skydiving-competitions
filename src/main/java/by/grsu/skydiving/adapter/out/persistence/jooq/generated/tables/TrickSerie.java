...
public class TrickSerie extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Integer> SERIE_NUMBER =
        createField(DSL.name("serie_number"), SQLDataType.INTEGER.nullable(false), this, "");
    /**
     * The column <code>public.trick_serie.time_without_penalty</code>.
     */
    public final TableField<Record, Double> TIME_WITHOUT_PENALTY =
        createField(DSL.name("time_without_penalty"), SQLDataType.DOUBLE, this, "");
    /**
     * The column <code>public.trick_serie.round_number</code>.
     */
    public final TableField<Record, Integer> ROUND_NUMBER =
        createField(DSL.name("round_number"), SQLDataType.INTEGER, this, "");
    /**
     * The column <code>public.trick_serie.is_time_submitted</code>.
     */
    public final TableField<Record, Boolean> IS_TIME_SUBMITTED = createField(DSL.name("is_time_submitted"),
    ...
    public List<ForeignKey<Record, ?>> getReferences() {
        return Arrays.asList(Keys.TRICK_SERIE__TRICK_SERIE_COMPETITION_MEMBER_DETAIL_ID_FKEY,
            Keys.TRICK_SERIE__TRICK_SERIE_REFEREE_ID_FKEY);
    }
    ...
    public CompetitionMemberDetail competitionMemberDetail() {
        if (_competitionMemberDetail == null) {
            _competitionMemberDetail =
                new CompetitionMemberDetail(this, Keys.TRICK_SERIE__TRICK_SERIE_COMPETITION_MEMBER_DETAIL_ID_FKEY);
        }
