...
public class UserInfo extends TableImpl<Record> {
    ...
    public final TableField<Record, String> FIRST_NAME =
        createField(DSL.name("first_name"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.user_info.second_name</code>.
     */
    public final TableField<Record, String> SECOND_NAME =
        createField(DSL.name("second_name"), SQLDataType.VARCHAR(50).nullable(false), this, "");
     ...
     */
    public final TableField<Record, Short> ROLE =
        createField(DSL.name("role"), SQLDataType.SMALLINT.nullable(false), this, "");
