...
public class Competition extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, LocalDateTime> BEGIN_DATE = createField(DSL.name("begin_date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>public.competition.end_date</code>.
     */
    public final TableField<Record, LocalDateTime> END_DATE = createField(DSL.name("end_date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

    /**
     * The column <code>public.competition.address</code>.
     */
    public final TableField<Record, String> ADDRESS = createField(DSL.name("address"), SQLDataType.VARCHAR(150).nullable(false), this, "");

    /**
     * The column <code>public.competition.status</code>.
     */
    public final TableField<Record, Integer> STATUS = createField(DSL.name("status"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.competition.number_of_stages</code>.
     */
    public final TableField<Record, Integer> NUMBER_OF_STAGES = createField(DSL.name("number_of_stages"), SQLDataType.INTEGER.nullable(false), this, "");
