...
public class PassportInfo extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> SERIES =
        createField(DSL.name("series"), SQLDataType.CHAR(2).nullable(false), this, "");

    /**
     * The column <code>public.passport_info.number</code>.
     */
    public final TableField<Record, String> NUMBER =
        createField(DSL.name("number"), SQLDataType.CHAR(7).nullable(false), this, "");

    /**
     * The column <code>public.passport_info.personal_number</code>.
     */
    public final TableField<Record, String> PERSONAL_NUMBER =
        createField(DSL.name("personal_number"), SQLDataType.CHAR(14).nullable(false), this, "");

    /**
     * The column <code>public.passport_info.issuing_authority</code>.
     */
    public final TableField<Record, String> ISSUING_AUTHORITY =
        createField(DSL.name("issuing_authority"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.passport_info.issued_date</code>.
     */
    public final TableField<Record, LocalDateTime> ISSUED_DATE =
        createField(DSL.name("issued_date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
