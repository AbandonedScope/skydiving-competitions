...
public class Jumping extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Double> HEIGHT =
        createField(DSL.name("height"), SQLDataType.DOUBLE.nullable(false), this, "");
    /**
     * The column <code>public.jumping.speed</code>.
     */
    public final TableField<Record, Double> SPEED =
        createField(DSL.name("speed"), SQLDataType.DOUBLE.nullable(false), this, "");
    /**
