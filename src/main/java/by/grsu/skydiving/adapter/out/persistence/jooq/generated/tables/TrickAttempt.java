...
public class TrickAttempt extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Long> TRICK_SERIE_ID = createField(DSL.name("trick_serie_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.trick_attempt.trick_type</code>.
     */
    public final TableField<Record, Integer> TRICK_TYPE = createField(DSL.name("trick_type"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.trick_attempt.arrow_penalty</code>.
     */
    public final TableField<Record, Integer> ARROW_PENALTY = createField(DSL.name("arrow_penalty"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.trick_attempt.d_penalty</code>.
     */
    public final TableField<Record, Integer> D_PENALTY = createField(DSL.name("d_penalty"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.trick_attempt.s_penalty</code>.
     */
    public final TableField<Record, Integer> S_PENALTY = createField(DSL.name("s_penalty"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.trick_attempt.minus_penalty</code>.
     */
    public final TableField<Record, Integer> MINUS_PENALTY = createField(DSL.name("minus_penalty"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>public.trick_attempt.plus_minus_penalty</code>.
     */
    public final TableField<Record, Integer> PLUS_MINUS_PENALTY = createField(DSL.name("plus_minus_penalty"), SQLDataType.INTEGER, this, "");
