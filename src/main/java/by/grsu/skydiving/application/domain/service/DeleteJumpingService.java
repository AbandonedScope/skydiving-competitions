...
public class DeleteJumpingService implements DeleteJumpingUseCase {
    private final GetRefereeableCompetitionUseCase getRefereeableCompetitionUseCase;
    ...
    public void delete(long competitionId, long jumpingId) {
        getRefereeableCompetitionUseCase.getCompetitionThatCanBeRefereed(competitionId);
