...
public class ErrorMessagesConstants {
    ...
    public static final String TIME_DELAY_OF_PARACHUT_OPENING_INCORRECT_VALUE_KEY =
        "incorrect_timeDelayOfParachutOpening";
    ...
    public static final String NEXT_JUMP_NUMBER_IN_COMPETITION_UNIT_INCORRECT_VALUE_KEY =
        "incorrect_nextJumpNumberInCompetition";
    ...
    public static final String PLACE_IS_NULL_OR_BLANK_OR_INCORRECT_LENGTH_MESSAGE =
        "User validation. Failed place check. Place is null or blank or incorrect length.";
    ...
    public static final String WEIGHT_OUT_OF_RANGE_OR_NULL_MESSAGE =
        "Skydiver validation. Failed weight check. Weight is null or out of range.";
    public static final String HEIGHT_OUT_OF_RANGE_OR_NULL_MESSAGE =
        "Skydiver validation. Failed height check. Height is null or out of range.";
    public static final String BEGIN_DATE_OF_SPORT_IS_NULL_OR_INCORRECT_DATE_MESSAGE =
        "Skydiver validation. Failed begin date of sport career check. Begin date of sport is null or incorrect date.";
    ...
    public static final String FLIGHT_HEIGHT_NULL_OR_NEGATIVE_MESSAGE =
        "Jumping validation. Failed flight height check. Flight height is null or negative";
    public static final String SPEED_NULL_OR_NEGATIVE_MESSAGE =
        "Jumping validation. Failed speed check. Speed is null or negative";
    public static final String TIME_DELAY_OF_PARACHUTE_OPENING_NULL_OR_NEGATIVE_MESSAGE =
        "Jumping validation. Failed timeDelayOfParachuteOpening check. TimeDelayOfParachutOpening is null or negative";
    public static final String AVIATION_UNIT_IS_NULL_OR_BLANK_OR_INCORRECT_LENGTH_MESSAGE =
        "Jumping validation. Failed aviation unit check. AviationUnit is null or blank or incorrect length.";
    public static final String JUMP_NUMBER_BILLABLE_IS_NULL_OR_NEGATIVE_MESSAGE =
        "Jumping validation. Failed jump number billable check. Jump number billable is null or negative";
    public static final String NEXT_JUMP_NUMBER_DURING_YEAR_IS_NULL_OR_NEGATIVE_MESSAGE =
        "Jumping validation. Failed next jump number during year check. Next jump number during year is null or negative";
