...
public class UpdateCompetitionJumpingService
    ...
    private final GetRefereeableCompetitionUseCase getUpdatableCompetitionUseCase;
    ...
    public JumpingInfo update(UpdateCompetitionJumpingCommand command) {
        ...
        getUpdatableCompetitionUseCase.getCompetitionThatCanBeRefereed(competitionId);
